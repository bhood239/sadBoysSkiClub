...
export default function About() {
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-4 md:py-12">
      ...
      <section
        id="mission"
        className="max-w-3xl mx-auto text-center mb-20 md:mb-32 scroll-mt-32"
      >
        <span className="text-stone-500 font-semibold tracking-wider uppercase text-xs md:text-sm mb-3 block">
          Who We Are
        </span>
      ...
      <section
        id="program"
        className="max-w-5xl mx-auto mb-20 md:mb-32 scroll-mt-32"
      >
        <div className="text-center mb-12 md:mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-base md:text-lg text-slate-600 leading-relaxed px-2">
            A unique blend of outdoor adventure and mental health support. We
            offer free group therapy sessions and individual support tailored
            specifically for men (18+), utilizing skiing as a therapeutic tool.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-12">
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-600 leading-relaxed text-sm md:text-base">
              Sessions take place before skiing in a supportive, relaxed
              environment. Led by a registered psychotherapist, these sessions
              encourage open dialogue and camaraderie, fostering trust before
              hitting the slopes.
            </p>
          </div>
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-stone-100 hover:shadow-md transition-shadow">
            ...
            <p className="text-slate-600 leading-relaxed text-sm md:text-base">
              While skiing, participants engage in conversations with trained
              mental health clinicians. This unique setting provides a
              comfortable space for discussing challenges and setting goals in
              nature.
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 text-stone-50 rounded-xl p-8 md:p-12 shadow-xl mb-16 relative overflow-hidden">
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-base md:text-lg opacity-90 leading-relaxed mb-8">
              Sessions start at 10 AM (4 hours duration). Participants must
              provide their own pass and gear.
              <strong> This is not a ski lesson</strong> — participants should
          ...
          <div className="group bg-white p-6 md:p-10 rounded-xl shadow-sm border border-stone-100 hover:shadow-lg transition-all duration-300">
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-stone-500 font-medium mb-4 text-sm md:text-base">
                  Founder & RCC
                </p>
                <p className="text-slate-600 leading-relaxed text-sm md:text-base">
                  Krista is a Registered Clinical Counsellor and the founder of
                  Slope Side Support Society. With a Master’s in Clinical Mental
                  Health Counselling, she specializes in therapeutic
                  intervention for youth trauma survivors. She combines her
                  passions for therapy and skiing to offer accessible, authentic
                  support in the Sea to Sky Corridor.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white p-6 md:p-10 rounded-xl shadow-sm border border-stone-100 hover:shadow-lg transition-all duration-300">
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-600 leading-relaxed text-sm md:text-base">
                  With 30 years in social service delivery, Greg specializes in
                  trauma, family systems, and individual therapy. He is also a
                  Mental Performance Consultant. A former elite athlete, Greg
                  believes in a balanced lifestyle and can be found skiing,
                  mountain biking, or surfing when not helping others.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white p-6 md:p-10 rounded-xl shadow-sm border border-stone-100 hover:shadow-lg transition-all duration-300">
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-slate-600 leading-relaxed text-sm md:text-base">
                  Taylor holds a master’s degree in social work and has worked
                  in mental health since 2012. Currently a clinician with
                  Vancouver Coastal Health, he is also active in the Alpine Club
                  of Canada. Taylor lives in Pemberton and enjoys skiing,
                  biking, and climbing.
                </p>
              </div>
            </div>
      ...
      <section id="partners" className="text-center pb-8 md:pb-12 scroll-mt-32">
        <span className="text-stone-500 font-semibold tracking-wider uppercase text-xs md:text-sm mb-6 md:mb-8 block">
          Supported By
        </span>
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center justify-center">
          ...
          <a
            href="https://mcdonnellcounselling.com/"
            className="bg-black p-3 md:p-4 rounded-xl opacity-80 hover:opacity-100 invert transition-opacity duration-300"
          >
            <Image
              src="/pictures/McDonnell_Counselling_logo_white.png"
              height={100}
              width={100}
              alt="McDonnell counselling logo"
              className="object-contain md:w-[120px] md:h-[120px]"
            />
          </a>
          <a
            href="https://whistlerblackcombfoundation.com/"
            className="opacity-60 hover:opacity-100 transition-opacity duration-300"
          >
            <Image
              src="/pictures/WBF_2020logo_RGB.avif"
              height={100}
              width={100}
              alt="Whistler Blackcomb Foundation logo"
              className="object-contain md:w-[120px] md:h-[120px]"
            />
          </a>
          <a
            href="https://www.vailresorts.com/responsibility/employee-foundation/"
            className="opacity-60 hover:opacity-100 transition-opacity duration-300"
          >
            <Image
              src="/pictures/epic_promise.avif"
              height={100}
              width={100}
              alt="Epic Promise Foundation logo"
              className="object-contain md:w-[120px] md:h-[120px]"
            />
          </a>
        </div>
